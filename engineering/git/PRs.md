...
Example:
```
Component refactor + people tests.

- [x] Modal removed from people.new/people.edit favouring a route instead
- [x] Refactored to a new "pods" structure
- [x] Refactore People as new components
```
